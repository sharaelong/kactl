/**
 * Author:
 * Description: Solve $Ax <= b$, max $c^T x$. Maximal value store in v, answer backtracking via sol[i]. 1-base index.
 * Time: exponential. fast $O(MN^2)$ in experiment. dependent on the modeling.
 */
#pragma once
